...
qemu-fuse.o qemu-img.o: qemu-img-cmds.h
qemu-fuse.o qemu-img.o qemu-tool.o qemu-nbd.o qemu-io.o cmd.o qemu-ga.o: $(GENERATED_HEADERS)
...
qemu-fuse$(EXESUF): qemu-fuse.o $(tools-obj-y) $(block-obj-y)
